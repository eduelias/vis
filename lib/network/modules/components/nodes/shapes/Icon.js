...
class Icon extends NodeBase {
    ...
    _icon(ctx, x, y, selected, hover, values) {
        ...
        if (this.options.icon.charcode !== undefined &&
            this.options.icon.charcode !== null) {
            this.options.icon.code = String.fromCharCode(parseInt(this.options.icon.charcode, 16));
        }
